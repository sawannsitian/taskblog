...
class TasklistsControllerTest < ActionController::TestCase
  ...
  test "should create tasklist" do
    assert_difference('Tasklist.count') do
      post :create, tasklist: { description: @tasklist.description, status: @tasklist.status, subject: @tasklist.subject, user_id: @tasklist.user_id }
    end
  ...
  test "should update tasklist" do
    put :update, id: @tasklist, tasklist: { description: @tasklist.description, status: @tasklist.status, subject: @tasklist.subject, user_id: @tasklist.user_id }
    assert_redirected_to tasklist_path(assigns(:tasklist))
  end
